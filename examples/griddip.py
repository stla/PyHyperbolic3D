...
for v in verts3d:
    ...
    pltr.add_mesh(sphere, color="whitesmoke", smooth_shading=True, specular=15)
for edge in edges:
    A = verts3d[edge[0], :]
    B = verts3d[edge[1], :]
    tube = gyrotube(A, B, s, 0.025)
    pltr.add_mesh(tube, color="whitesmoke", smooth_shading=True, specular=15)
for square in squares:
    ...
    pltr.add_mesh(mesh, color="#8B2252", smooth_shading=True, specular=15)
